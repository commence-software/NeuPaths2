...
/**
 * Handler for parsing a {@link LogicCell}'s configuration.
 *
 * @author Aaron Caraveo
 */
final class Cfg_LogicCellHandler extends Cfg_CellHandler implements Cfg_ActivatorsHandlerInt
{
  Cfg_LogicCellHandler ()
  {
    super(CellType.LOGIC, "/Logic_Cell");
